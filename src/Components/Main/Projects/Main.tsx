...
const Main = () => {
  ...
  return (
    <>
      <div id="home" className="main-contents p-100px flex flex-col flex-1 justify-center md:text-center container m-[0_auto] !p-[0_20px]">
        <EncryptedWords />
        <div className="hero-text mb-[60px] ">
          <h1 id="header" className="hero-header text-center text-[clamp(80px,15vw,240px)] font-black leading-[0.85] -tracking-[4px] mb-[30px] relative">
            <div className={`relative inline-flex flex-wrap w-full text-normal ${isDark ? "!text-[#F28F3B] drop-shadow-[0_0_40px_rgba(242,143,59,0.3)]" : "!text-[#ff391e] drop-shadow-[0_0_40px_rgba(255,57,30,0.2)]"} text-center cursor-default select-none`}>
