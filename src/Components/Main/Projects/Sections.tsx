    ...
    <>
        <section className="p-[100px_0] relative">
            <div className="section-header mb-20 relative ">
                ...
                <h2 id={heading==="Projects" ? "projects" : "arsenal"} className="text text-[clamp(50px,10vw,140px)] font-bold uppercase -tracking-[2px] text-[#D1D1D1] leading-0 relative inline-block">{heading}</h2>
