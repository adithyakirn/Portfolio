...
const Arsenal = () => {
  ...
  return (
    <>
        <section className="p-[100px_20px] relative -mt-[340vh] container m-[0_auto]">
            <div className="section-header mb-20 relative ">
                ...
                <h2 id="arsenal"  className={`text text-[clamp(50px,10vw,140px)] font-bold uppercase -tracking-[2px] ${isDark ? "text-[#D1D1D1]" : "text-black" } leading-0 relative inline-block drop-shadow-[0_0_40px_rgba(252,252,252,0.2)]`}>Arsenal</h2>
