  ...
  <>
    <section id="projects-wrapper" className="min-h-screen p-[100px_20px] lg:pl-[100px] m-[0_auto] relative section">
      <div className="section-header mb-20 relative ">
        ...
        <h2 id="projects" className="text text-[clamp(50px,10vw,140px)] font-bold uppercase -tracking-[2px] text-[#D1D1D1] leading-0 relative inline-block drop-shadow-[0_0_40px_rgba(252,252,252,0.2)]">Projects</h2>
